This is a version of PyFITS which has been modified to run on recent
Python versions including 3.10 by Jeremy Sanders.

The aim of this is for a compact fits reader without the large
